class WheelsBe < Formula
  ...
  LUCLI_VERSION = "0.6.2"
  MODULE_VERSION = "4.1.0-snapshot.2446"
  ...
  resource "wheels_module" do
    ...
    sha256 "fced79d533c567b4a0a93b107b9be3399a2db9bed55b3550069dd6690cf6aab5"
  end

  resource "wheels_core" do
    url "https://github.com/wheels-dev/wheels-snapshots/releases/download/v#{MODULE_VERSION}/wheels-core-#{MODULE_VERSION}.zip"
    sha256 "b36d83ef4deed12c573097596b285f97c9189dd716d0769399158cfbb63b3d62"
  end
