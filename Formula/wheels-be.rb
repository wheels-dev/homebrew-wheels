class WheelsBe < Formula
  ...
  LUCLI_VERSION = "0.3.7"
  MODULE_VERSION = "4.0.3-snapshot.1976"
  ...
  resource "wheels_module" do
    ...
    sha256 "ae8fae2a28ff7268508f45f427acbecb4a33ddb5c0ed7c495e6335b02daf9195"
  end

  resource "wheels_core" do
    url "https://github.com/wheels-dev/wheels-snapshots/releases/download/v#{MODULE_VERSION}/wheels-core-#{MODULE_VERSION}.zip"
    sha256 "74671403130c37ba5fc5a131e3201116f7bab3d3441331d0bdc4340c0901e5cc"
  end
