class WheelsBe < Formula
  ...
  LUCLI_VERSION = "0.3.7"
  MODULE_VERSION = "4.0.2-snapshot.1928"
  ...
  resource "wheels_module" do
    ...
    sha256 "b6d70bc7048cced5b1952883994d53ac6771213d4edd8fe52fb850b839982896"
  end

  resource "wheels_core" do
    url "https://github.com/wheels-dev/wheels-snapshots/releases/download/v#{MODULE_VERSION}/wheels-core-#{MODULE_VERSION}.zip"
    sha256 "4c86d11213e88f157bf7d4a8a8d1d008bfcfde5d5814028fb1762c69ede07cd7"
  end
