class WheelsBe < Formula
  ...
  LUCLI_VERSION = "0.3.7"
  MODULE_VERSION = "4.0.1-snapshot.1881"
  ...
  resource "wheels_module" do
    ...
    sha256 "337b08105dbfd4f28673e4ce86ae1676968d59dee6e7988764a285ed76eacee5"
  end

  resource "wheels_core" do
    url "https://github.com/wheels-dev/wheels-snapshots/releases/download/v#{MODULE_VERSION}/wheels-core-#{MODULE_VERSION}.zip"
    sha256 "6ce402b6db8c6a004d70558e1b67a6050968ce5fb1ab7f06a1ac2ff4661091db"
  end
